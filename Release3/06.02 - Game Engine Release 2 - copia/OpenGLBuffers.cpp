...
void OpenGLBuffers::initializeVertexArrayObject(GLSLProgram & _colorProgram) {	
	...
	glEnableVertexAttribArray(_colorProgram.getAttribLocation("vertexColor"));
		...
		//Connect the uv to the "vertexUB" attribute of the vertex shader
	...
	*/
	...
	glVertexAttribPointer(_colorProgram.getAttribLocation("vertexUV"), 2, GL_FLOAT, GL_FALSE, sizeof(Vertex), (void*)offsetof(Vertex, _uv));
